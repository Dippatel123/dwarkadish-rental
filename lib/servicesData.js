...
export const servicesData = {
  'chandelier-rental': {
    ...
    en: {
      ...
      description: 'Transform any venue into a majestic celebration with our exquisite collection of crystal and designer chandeliers. From elegant traditional pieces to modern statement lighting, we have chandeliers for every wedding theme and event scale.',
      features: [
    ...
    gu: {
      ...
      description: 'અમારા ઉત્કૃષ્ટ ક્રિસ્ટલ અને ડિઝાઇનર ઝુમ્મરના સંગ્રહ સાથે કોઈપણ સ્થળને ભવ્ય ઉજવણીમાં ફેરવો. પરંપરાગત ટુકડાઓથી લઈને આધુનિક લાઇટિંગ સુધી, દરેક લગ્ન થીમ માટે ઝુમ્મર ઉપલબ્ધ છે.',
      features: [
  ...
  'decorative-diya-rental': {
    ...
    en: {
      ...
      description: 'Illuminate your celebrations with our handpicked collection of decorative diyas. From classic brass hanging diyas to modern floor and pedestal designs — perfect for aarti, mandap and pooja setups.',
      features: [
      ...
      priceFrom: '₹150 / diya / day',
      cta: 'Book Diyas',
    },
    gu: {
      title: 'ડેકોરેટિવ દીવા ભાડે',
      tagline: 'ગરમ, પવિત્ર ચમક માટે પરંપરાગત પિત્તળ અને ડિઝાઇનર દીવા',
      description: 'અમારા હાથથી પસંદ કરેલા ડેકોરેટિવ દીવાના સંગ્રહ સાથે તમારી ઉજવણીને પ્રકાશિત કરો. પરંપરાગત પિત્તળના લટકતા દીવાથી લઈને આધુનિક ડિઝાઇન સુધી — આરતી, મંડપ અને પૂજા સેટઅપ માટે યોગ્ય.',
      features: [
      ...
      priceFrom: '₹૧૫૦ / દીવો / દિવસ',
      cta: 'દીવા બુક કરો',
    },
    gallery: [
      'https://images.unsplash.com/photo-1605349635224-b0b3fe1cfd52?fm=jpg&q=70&w=1600&auto=format&fit=crop',
      'https://images.unsplash.com/photo-1573551565108-de9c39786be9?fm=jpg&q=70&w=1600&auto=format&fit=crop',
      'https://images.unsplash.com/photo-1604423043492-41303f83a51e?fm=jpg&q=70&w=1600&auto=format&fit=crop',
      'https://images.unsplash.com/photo-1573551461807-e77faabe7fb3?fm=jpg&q=70&w=1600&auto=format&fit=crop',
      'https://images.unsplash.com/photo-1636202267085-e3d0d4b12a08?fm=jpg&q=70&w=1600&auto=format&fit=crop',
      'https://images.unsplash.com/photo-1636202429770-e0a1e4b6b7e2?fm=jpg&q=70&w=1600&auto=format&fit=crop',
    ],
  },
  'air-cooler-rental': {
    ...
    en: {
      ...
      description: 'Beat the summer heat with our range of industrial and residential air coolers. Perfect for outdoor mandaps, halls, and open-air functions. Powerful airflow, silent operation and clean water tanks guaranteed.',
      features: [
      ...
      priceFrom: '₹800 / cooler / day',
      cta: 'Book a Cooler',
    },
    gu: {
      title: 'એર કૂલર ભાડે',
      tagline: 'દરેક મહેમાનને આરામદાયક રાખવા શક્તિશાળી કૂલર',
      description: 'અમારા ઔદ્યોગિક અને રહેણાંક એર કૂલરની શ્રેણી સાથે ઉનાળાની ગરમીને હરાવો. બહાર મંડપ, હોલ અને ખુલ્લી હવાના ફંક્શન માટે યોગ્ય.',
      features: [
      ...
      priceFrom: '₹૮૦૦ / કૂલર / દિવસ',
      cta: 'કૂલર બુક કરો',
    },
    gallery: [
      'https://images.unsplash.com/photo-1631545806609-e0d5f3aef21e?fm=jpg&q=70&w=1600&auto=format&fit=crop',
      'https://images.unsplash.com/photo-1585771362941-25c1adc82afc?fm=jpg&q=70&w=1600&auto=format&fit=crop',
  ...
  'heater-rental': {
    ...
    en: {
      ...
      description: 'Keep your winter events warm and inviting with our range of gas and electric heaters. Ideal for outdoor mandaps, evening functions, and reception halls during Gujarat winters.',
      features: [
      ...
      priceFrom: '₹1,000 / heater / day',
      cta: 'Book a Heater',
    },
    gu: {
      title: 'હીટર ભાડે',
      tagline: 'આરામદાયક શિયાળાના લગ્નો માટે પ્રીમિયમ હીટર',
      description: 'અમારી ગેસ અને ઇલેક્ટ્રિક હીટરની શ્રેણી સાથે તમારા શિયાળુ પ્રસંગોને ગરમ રાખો. બહાર મંડપ અને સાંજના ફંક્શન માટે આદર્શ.',
      features: [
      ...
      priceFrom: '₹૧,૦૦૦ / હીટર / દિવસ',
      cta: 'હીટર બુક કરો',
    },
    gallery: [
      'https://images.unsplash.com/photo-1544963950-72e0eb42d357?fm=jpg&q=70&w=1600&auto=format&fit=crop',
      'https://images.unsplash.com/photo-1516455590571-18256e5bb9ff?fm=jpg&q=70&w=1600&auto=format&fit=crop',
      'https://images.unsplash.com/photo-1544963151-6ba9c0c17a1e?fm=jpg&q=70&w=1600&auto=format&fit=crop',
      'https://images.unsplash.com/photo-1519750013443-0b923d38112c?fm=jpg&q=70&w=1600&auto=format&fit=crop',
  ...
  'fan-rental': {
    ...
    en: {
      ...
      description: 'From pedestal fans to industrial ceiling fans, we cover all your ventilation needs. Perfect for tents, halls, and outdoor mandaps where guest comfort is the priority.',
      features: [
      ...
      priceFrom: '₹300 / fan / day',
      cta: 'Book a Fan',
    },
    gu: {
      title: 'પંખા ભાડે',
      tagline: 'મોટા સ્થળો માટે ઉચ્ચ-કાર્યક્ષમતાવાળા પંખા',
      description: 'પેડેસ્ટલ પંખાથી ઔદ્યોગિક છત પંખા સુધી, અમે તમારી બધી વેન્ટિલેશન જરૂરિયાતોને આવરી લઈએ છીએ. તંબુ, હોલ અને બહાર મંડપ માટે યોગ્ય.',
      features: [
      ...
      priceFrom: '₹૩૦૦ / પંખો / દિવસ',
      cta: 'પંખા બુક કરો',
    },
    gallery: [
      'https://images.unsplash.com/photo-1621244335430-1a04dee49bcb?fm=jpg&q=70&w=1600&auto=format&fit=crop',
      'https://images.unsplash.com/photo-1585771362941-25c1adc82afc?fm=jpg&q=70&w=1600&auto=format&fit=crop',
  ...
  'wedding-decoration-items': {
    ...
    en: {
      ...
      description: 'End-to-end wedding decoration solutions — from mandap setup to entrance decor to stage design. Choose from traditional, royal, floral and contemporary themes.',
      features: [
      ...
      priceFrom: '₹15,000 / event',
      cta: 'Design My Wedding',
    },
    gu: {
      title: 'લગ્ન સજાવટની વસ્તુઓ',
      tagline: 'સંપૂર્ણ મંડપ અને સ્ટેજ સજાવટ પેકેજ',
      description: 'મંડપ સેટઅપથી પ્રવેશ સજાવટ અને સ્ટેજ ડિઝાઇન સુધી — સંપૂર્ણ લગ્ન સજાવટ ઉકેલો. પરંપરાગત, રોયલ, ફ્લોરલ અને સમકાલીન થીમમાંથી પસંદ કરો.',
      features: [
  ...
  'event-decoration-accessories': {
    ...
    en: {
      ...
      description: 'Everything you need to transform any space into a stunning event venue. From satin backdrops and drapes to elegant pillars and props, we have the finishing touches your event deserves.',
      features: [
      ...
      priceFrom: '₹5,000 / event',
      cta: 'Explore Accessories',
    },
    gu: {
      title: 'ઇવેન્ટ સજાવટ સહાયક',
      tagline: 'બેકડ્રોપ, પડદા, થાંભલા અને દરેક ઉજવણી માટે વધુ',
      description: 'કોઈપણ જગ્યાને અદભૂત ઇવેન્ટ સ્થળમાં ફેરવવા માટે તમને જરૂરી બધું. સેટિન બેકડ્રોપથી લઈને થાંભલા અને પ્રોપ્સ સુધી.',
      features: [
  ...
  'festival-decoration-rentals': {
    ...
    en: {
      ...
      description: 'Special festival packages for Navratri, Diwali, Ganesh Chaturthi and society events. Complete themed decoration with lights, torans, rangoli setups and cultural props.',
      features: [
      ...
      priceFrom: '₹8,000 / event',
      cta: 'Plan My Festival',
    },
    gu: {
      title: 'તહેવાર સજાવટ ભાડે',
      tagline: 'દિવાળી, નવરાત્રી અને સામુદાયિક તહેવારો માટે ખાસ સજાવટ',
      description: 'નવરાત્રી, દિવાળી, ગણેશ ચતુર્થી અને સોસાયટી પ્રસંગો માટે વિશેષ પેકેજ. લાઇટ, તોરણ, રંગોળી અને સાંસ્કૃતિક પ્રોપ્સ સાથે સંપૂર્ણ થીમ સજાવટ.',
      features: [
