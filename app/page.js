...
import diva from "@/assets/diva.jpeg";
        ...
        <div className="container flex items-center justify-between h-20 md:h-24">
          ...
          <nav className="hidden lg:flex items-center gap-1">
            {nav.map((n) => (
              <a
                key={n.href}
                href={n.href}
                className={`px-4 py-2 text-sm font-medium hover:text-primary transition-colors rounded-lg hover:bg-accent ${scrolled ? "text-foreground/80" : "text-white/90"} ${lang === "gu" ? "font-gujarati" : ""}`}
              >
                {n.label}
              </a>
            ))}
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className={`hidden md:flex items-center gap-1.5 px-3 py-2 rounded-lg hover:bg-accent text-sm font-medium transition-colors ${scrolled ? "text-foreground" : "text-white/90"}`}
              aria-label="Language"
            >
            ...
            {mounted && (
              <button
                ...
                className={`p-2 rounded-lg hover:bg-accent transition-colors ${scrolled ? "text-foreground" : "text-white/90"}`}
                aria-label="Theme"
              >
                {theme === "dark" ? (
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="hidden md:inline-flex items-center gap-1.5 px-3 py-2 rounded-lg bg-emerald-500 hover:bg-emerald-600 text-white text-sm font-medium transition-colors"
            >
            ...
            <a
              ...
              className="hidden md:inline-flex items-center gap-1.5 px-3 py-2 rounded-lg bg-maroon-800 hover:bg-gold-500 hover:text-maroon-900 text-white text-sm font-medium transition-all"
            >
            ...
            <button
              ...
              className={`lg:hidden p-2 rounded-lg hover:bg-accent ${scrolled ? "text-foreground" : "text-white/90"}`}
              aria-label="Menu"
            >
        ...
        {open && (
          <>
            ...
            <motion.aside
              ...
              className="fixed top-0 right-0 bottom-0 z-[70] w-[85%] max-w-sm bg-background border-l border-border shadow-2xl lg:hidden"
            >
              ...
              <nav className="p-4 flex flex-col gap-1">
                {nav.map((n) => (
                  <a
                    ...
                    href={n.href}
                    onClick={() => setOpen(false)}
                    className={`px-4 py-3 rounded-lg hover:bg-accent flex items-center justify-between text-base font-medium ${lang === "gu" ? "font-gujarati" : ""}`}
                  >
              ...
              <div className="p-4 border-t border-border space-y-2">
                <button
                  onClick={() => setLang(lang === "en" ? "gu" : "en")}
                  className="w-full flex items-center justify-center gap-2 py-2.5 rounded-lg border border-border hover:bg-accent font-medium"
                >
                  <Languages className="w-4 h-4" />
                  <span className={lang === "gu" ? "font-gujarati" : ""}>
                    {lang === "en" ? "ગુજરાતી" : "English"}
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="w-full flex items-center justify-center gap-2 py-2.5 rounded-lg bg-emerald-500 text-white font-medium"
                >
                  <MessageCircle className="w-4 h-4" /> {t.nav.whatsapp}
                </a>
                <a
                  href={`tel:${BUSINESS.phoneRaw}`}
                  className="w-full flex items-center justify-center gap-2 py-2.5 rounded-lg bg-maroon-800 text-white font-medium"
                >
...
function Hero({ t, lang }) {
  ...
  return (
    <section
      id="home"
      className="relative min-h-[100svh] flex items-center overflow-hidden pt-20 md:pt-24"
    >
      ...
      <motion.div style={{ opacity }} className="container relative z-10 py-20">
        <div className="max-w-4xl">
          ...
          >
            <Badge
              className={`mb-6 bg-gold-500/20 text-gold-300 border border-gold-500/40 hover:bg-gold-500/30 backdrop-blur-md px-4 py-1.5 text-xs md:text-sm ${lang === "gu" ? "font-gujarati" : ""}`}
            >
          ...
          <motion.h1
            ...
            className={`font-display text-3xl sm:text-4xl md:text-7xl lg:text-8xl font-bold text-white leading-[1.25] tracking-tight ${lang === "gu" ? "font-gujarati" : ""}`}
          >
            {t.hero.title1}{" "}
            <span className="text-gradient-gold italic inline-block leading-[1.15] pb-1">
              {t.hero.title2}
            </span>
            <br />
            <span className="text-xl sm:text-2xl md:text-5xl lg:text-6xl font-light text-white/90">
              {t.hero.title3}
            </span>
          </motion.h1>
          ...
          <motion.p
            ...
            className={`mt-6 md:mt-8 text-sm sm:text-base md:text-xl text-white/80 max-w-2xl leading-relaxed ${lang === "gu" ? "font-gujarati" : ""}`}
          >
            {t.hero.subtitle}
          </motion.p>
          ...
          >
            <a
              href={`https://wa.me/${BUSINESS.whatsapp}?text=Hi, I would like to book decoration items for my event.`}
              target="_blank"
              rel="noreferrer"
            >
              <Button
                size="lg"
                className={`bg-gold-gradient text-maroon-900 hover:brightness-110 shadow-gold h-12 md:h-14 px-6 md:px-8 text-sm md:text-base font-semibold rounded-xl group ${lang === "gu" ? "font-gujarati" : ""}`}
              >
            ...
            <a href={`tel:${BUSINESS.phoneRaw}`}>
              <Button
                size="lg"
                variant="outline"
                className={`border-white/40 bg-white/10 backdrop-blur-md text-white hover:bg-white/20 hover:text-white h-12 md:h-14 px-6 md:px-8 text-sm md:text-base font-semibold rounded-xl ${lang === "gu" ? "font-gujarati" : ""}`}
              >
          ...
          <motion.div
            ...
            className={`mt-10 md:mt-14 flex flex-wrap gap-4 md:gap-6 ${lang === "gu" ? "font-gujarati" : ""}`}
          >
...
function SectionHeader({ badge, title, subtitle, lang, align = "center" }) {
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      className={`mb-10 md:mb-14 ${align === "center" ? "text-center max-w-3xl mx-auto" : ""}`}
    >
      <Badge
        className={`mb-4 bg-maroon-800/10 text-maroon-800 dark:bg-gold-500/10 dark:text-gold-400 border-none px-3 py-1 ${lang === "gu" ? "font-gujarati" : ""}`}
      >
        {badge}
      </Badge>
      <h2
        className={`font-display text-2xl sm:text-3xl md:text-5xl font-bold leading-tight tracking-tight ${lang === "gu" ? "font-gujarati" : ""}`}
      >
        {title}
      </h2>
      {subtitle && (
        <p
          className={`mt-4 text-muted-foreground text-sm sm:text-base md:text-lg ${lang === "gu" ? "font-gujarati" : ""}`}
        >
          {subtitle}
        </p>
      )}
              ...
              >
                <Link href={`/services/${slug}`} className="block h-full">
                  <Card className="group overflow-hidden h-full border-border/60 hover:border-gold-400/60 hover:shadow-luxe transition-all duration-300 bg-card cursor-pointer">
                    ...
                    <div className="p-5">
                      <h3
                        className={`font-display font-bold text-lg mb-2 ${lang === "gu" ? "font-gujarati" : ""}`}
                      >
                        {s.title}
                      </h3>
                      <p
                        className={`text-sm text-muted-foreground leading-relaxed mb-4 ${lang === "gu" ? "font-gujarati" : ""}`}
                      >
                        {s.desc}
                      </p>
                      <div
                        className={`inline-flex items-center gap-1 text-sm font-medium text-primary group-hover:gap-2 transition-all ${lang === "gu" ? "font-gujarati" : ""}`}
                      >
              ...
              >
                <Card className="p-6 md:p-8 h-full text-center border-border/60 hover:border-gold-400/60 hover:shadow-luxe transition-all duration-300 group bg-card relative overflow-hidden">
                  ...
                  <div className="relative">
                    ...
                    <h3
                      className={`font-display font-bold text-lg md:text-xl mb-2 ${lang === "gu" ? "font-gujarati" : ""}`}
                    >
                      {w.title}
                    </h3>
                    <p
                      className={`text-sm text-muted-foreground leading-relaxed ${lang === "gu" ? "font-gujarati" : ""}`}
                    >
                      {w.desc}
                    </p>
                  </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 md:gap-4 grid-flow-dense auto-rows-[140px] sm:auto-rows-[160px] md:auto-rows-[170px] lg:auto-rows-[190px]">
          {galleryImgs.map((src, i) => (
            <motion.button
              ...
              className={`relative overflow-hidden rounded-2xl group cursor-pointer ${i % 5 === 0 ? "row-span-2" : "row-span-1"}`}
            >
              <Image
                src={src}
                alt="Gallery"
    ...
    <section id="about" className="py-20 md:py-32 relative">
      <div className="container min-w-0">
        <div className="grid lg:grid-cols-2 gap-10 md:gap-16 items-center min-w-0">
          ...
          >
            <div className="relative aspect-[5/5] rounded-3xl overflow-hidden shadow-luxe">
              <Image
                src={galleryImgs[7]}
                alt="About"
                fill
            ...
            <div className="absolute -bottom-4 right-2 sm:-right-6 md:bottom-8 md:-right-8 w-24 h-24 sm:w-32 sm:h-32 md:w-40 md:h-40 rounded-3xl bg-gold-gradient shadow-gold flex flex-col items-center justify-center text-maroon-900 rotate-3">
              ...
              <div
                className={`text-xs md:text-sm font-medium text-center px-2 ${lang === "gu" ? "font-gujarati" : ""}`}
              >
                {t.about.exp}
              </div>
            </div>
          ...
          >
            <Badge
              className={`mb-4 bg-maroon-800/10 text-maroon-800 dark:bg-gold-500/10 dark:text-gold-400 border-none ${lang === "gu" ? "font-gujarati" : ""}`}
            >
              {t.about.badge}
            </Badge>
            <h2
              className={`font-display text-2xl sm:text-3xl md:text-5xl font-bold mb-6 leading-tight ${lang === "gu" ? "font-gujarati" : ""}`}
            >
              {t.about.title}
            </h2>
            <p
              className={`text-muted-foreground text-sm sm:text-base md:text-lg leading-relaxed mb-4 ${lang === "gu" ? "font-gujarati" : ""}`}
            >
              {t.about.p1}
            </p>
            <p
              className={`text-muted-foreground text-sm sm:text-base md:text-lg leading-relaxed mb-8 ${lang === "gu" ? "font-gujarati" : ""}`}
            >
              {t.about.p2}
            </p>
            ...
            <div className="grid grid-cols-2 gap-4 mb-8">
              <Card className="p-5 border-gold-400/30 bg-gold-500/5">
                <div
                  className={`text-xs uppercase tracking-wider text-gold-700 dark:text-gold-400 font-semibold mb-1 ${lang === "gu" ? "font-gujarati" : ""}`}
                >
                  {t.about.mission}
                </div>
                <p
                  className={`text-sm ${lang === "gu" ? "font-gujarati" : ""}`}
                >
                  {t.about.missionText}
                </p>
              </Card>
              <Card className="p-5 border-maroon-400/30 bg-maroon-500/5">
                <div
                  className={`text-xs uppercase tracking-wider text-maroon-800 dark:text-gold-400 font-semibold mb-1 ${lang === "gu" ? "font-gujarati" : ""}`}
                >
                  {t.about.vision}
                </div>
                <p
            ...
            <div className="grid grid-cols-4 gap-3">
              {stats.map((s) => (
                <div key={s.label} className="text-center">
                  <div className="font-display text-2xl md:text-3xl font-bold text-gradient-maroon dark:text-gradient-gold">
                    {s.value}
                  </div>
                  <div
                    className={`text-[10px] md:text-xs text-muted-foreground mt-1 ${lang === "gu" ? "font-gujarati" : ""}`}
                  >
                    {s.label}
                  </div>
                </div>
...
function Field({ label, children, lang }) {
  return (
    <div>
      <label
        className={`block text-sm font-medium mb-2 ${lang === "gu" ? "font-gujarati" : ""}`}
      >
        {label}
      </label>
      {children}
...
function InfoCard({ icon: Icon, label, value, href, color = "gold", lang }) {
  const content = (
    <Card className="p-4 flex items-center gap-4 border-border/60 hover:border-gold-400/60 hover:shadow-luxe transition-all group cursor-pointer bg-card">
      <div
        className={`w-11 h-11 rounded-xl flex items-center justify-center flex-shrink-0 ${color === "emerald" ? "bg-emerald-500" : "bg-gold-gradient"}`}
      >
        <Icon
          className={`w-5 h-5 ${color === "emerald" ? "text-white" : "text-maroon-900"}`}
        />
      </div>
      <div className="min-w-0 flex-1">
        <div
          className={`text-xs text-muted-foreground uppercase tracking-wider ${lang === "gu" ? "font-gujarati" : ""}`}
        >
          {label}
        </div>
        <div
          className={`font-medium truncate ${lang === "gu" ? "font-gujarati" : ""}`}
        >
          {value}
        </div>
      </div>
...
function ContactForm({ t, lang }) {
  ...
  const onSubmit = async (e) => {
    ...
    if (!form.name || !form.phone) {
      toast.error(
        lang === "gu" ? "નામ અને ફોન જરૂરી છે" : "Name and phone are required",
      );
      return;
    }
    setLoading(true);
      ...
      <div className="container min-w-0">
        <div className="grid lg:grid-cols-5 gap-8 md:gap-12 min-w-0">
            ...
            <Card className="p-4 sm:p-6 md:p-8 border-border/60 shadow-luxe bg-card min-w-0">
              <form onSubmit={onSubmit} className="space-y-5">
                ...
                <Field label={t.contact.items} lang={lang}>
                  <Select
                    value={form.items}
                    onValueChange={(v) => setForm({ ...form, items: v })}
                  >
                    <SelectTrigger
                      className={lang === "gu" ? "font-gujarati" : ""}
                    >
                ...
                <Button
                  ...
                  disabled={loading}
                  size="lg"
                  className={`w-full bg-maroon-800 hover:bg-gold-500 hover:text-maroon-900 text-white h-12 md:h-14 rounded-xl font-semibold text-base transition-all group ${lang === "gu" ? "font-gujarati" : ""}`}
                >
                  {loading ? (
                    t.contact.sending
                  ) : (
          ...
          >
            <div className="mb-2">
              <Badge
                className={`mb-3 bg-maroon-800/10 text-maroon-800 dark:bg-gold-500/10 dark:text-gold-400 border-none ${lang === "gu" ? "font-gujarati" : ""}`}
              >
                {t.contactInfo.badge}
              </Badge>
              <h3
                className={`font-display text-xl sm:text-2xl md:text-3xl font-bold ${lang === "gu" ? "font-gujarati" : ""}`}
              >
                {t.contactInfo.title}
              </h3>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3 pt-3">
              <a href={`tel:${BUSINESS.phoneRaw}`} className="w-full">
                <Button
                  className={`w-full bg-maroon-800 hover:bg-maroon-900 text-white rounded-xl h-11 ${lang === "gu" ? "font-gujarati" : ""}`}
                >
  ...
  return (
    <div className="fixed bottom-5 right-5 z-40 flex flex-col gap-3">
      <motion.a
        ...
        whileTap={{ scale: 0.95 }}
        className="w-14 h-14 rounded-full bg-emerald-500 text-white flex items-center justify-center shadow-2xl relative"
        aria-label="WhatsApp"
      >
      ...
      <motion.a
        ...
        whileHover={{ scale: 1.1 }}
        whileTap={{ scale: 0.95 }}
        className="w-14 h-14 rounded-full bg-maroon-800 text-white flex items-center justify-center shadow-2xl"
        aria-label="Call"
      >
